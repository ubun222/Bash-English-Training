...
![BET-ish.gif](https://github.com/ubun222/zh_CN/raw/bash/img/BET-ish.gif) ![BET-termux.gif](https://github.com/ubun222/zh_CN/raw/bash/img/BET-termux.gif)
#### 开始
...
apk add bash
apk add git
git clone git@github.com:ubun222/zh_CN.git
chmod +x ./zh_CN/*.sh
bash main.sh
```
