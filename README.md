...
![BET-ish.gif](https://github.com/ubun222/Bash_EN_ZH_Training/raw/bash/img/BET-ish.gif) ![BET-termux.gif](https://github.com/ubun222/Bash_EN_ZH_Training/raw/bash/img/BET-termux.gif)
#### 开始
...
apk add bash
apk add git
git clone git@github.com:ubun222/Bash_EN_ZH_Training.git
chmod +x ./Bash_EN_ZH_Training/*.sh
bash main.sh
```
