...
clear
stty -echo
[[  $COLUMN -ge 34  ]] && prt "\033[1m$hello\r$hi\n$hey"
sleep 0.1
echo
...
scanf=
stty -echo
printf "\033[1m$question"\\033[0m\\033[3m\\033[2m\ \‹———\›\ \\\033[0m #ishprt已不需要
  scanfd=
  thelast=
  bd=
continue
...
printf  "\033[0m$question1"\\033[2m\\033[3m\ \‹———\›\ "\033[0m$bot"\\r
[[  $COLUMN -lt $length  ]] && printf "\033[$(($((length-1))/COLUMN))A"
printf "\033[1m$(modify "$question1")\033[0m\033[2m"\\033[3m\ \‹———\›\ "\033[0m"
Readen
